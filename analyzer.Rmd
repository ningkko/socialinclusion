...
col_names <- c("job","marriage", "group","gender","has_local_child","from_rural")
...
dat$migration.scale <- relevel(as.factor(dat$migration.scale), ref = "intercounty")
...
mod3 <- glm(pos_stay ~ group + city_inclusion + money.left + 
            ...
            gender + migration.scale + housing_type + from_rural + time_stayed, data=dat)
summary(mod3)
```
